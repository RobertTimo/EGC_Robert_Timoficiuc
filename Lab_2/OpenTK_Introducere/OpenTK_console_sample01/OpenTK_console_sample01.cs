...
namespace OpenTK_console_sample01 {
    class SimpleWindow : GameWindow {
        ...
        public List<Vector2> baseList = new List<Vector2>
        {
        ...
        protected override void OnRenderFrame(FrameEventArgs e) {
            ...
            GL.Vertex2(baseList[0]);
            GL.Color3(Color.SpringGreen);
            GL.Vertex2(baseList[1]);
            GL.Color3(Color.Ivory);
            GL.Vertex2(baseList[2]);
        ...
        public void move_up() {
            ...
            {
                baseList[i] = new Vector2(baseList[i].X, baseList[i].Y + 1);
            }
